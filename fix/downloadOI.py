...
for ind in range(0, len(classes)):
    ...
    # subprocess.run([ 'mkdirs', run_mode+'/'+class_name])
    ...
    for line in class_annotations:
        ...
        command = 'aws s3 --no-sign-request --only-show-errors cp s3://open-images-dataset/'+run_mode+'/'+line_parts[0]+'.jpg '+ run_mode+'/'+line_parts[0]+'.jpg'
